...
<nav class="social-links" aria-label="Enlaces a redes sociales">
 ...
 <!-- TikTok -->
    <a href="https://www.tiktok.com/@w4vzen" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
      <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M12 0c-.1 0-.2.1-.2.2v9.5a4.3 4.3 0 01-4.3-4.3c0-.1 0-.2-.2-.2H6c-.1 0-.2.1-.2.2 0 4.1 3.3 7.5 7.5 7.5.1 0 .2 0 .2-.2V3.2h3.2c.1 0 .2-.1.2-.2 0-.1-.1-.2-.2-.2h-3.2z"/>
      </svg>
    </a>
